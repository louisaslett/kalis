...
_theta32              = KALIS_FMA_DOUBLE(_theta32, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta33              = KALIS_FMA_DOUBLE(_theta33, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta34              = KALIS_FMA_DOUBLE(_theta34, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta35              = KALIS_FMA_DOUBLE(_theta35, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta36              = KALIS_FMA_DOUBLE(_theta36, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta37              = KALIS_FMA_DOUBLE(_theta37, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta38              = KALIS_FMA_DOUBLE(_theta38, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta39              = KALIS_FMA_DOUBLE(_theta39, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta40              = KALIS_FMA_DOUBLE(_theta40, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta41              = KALIS_FMA_DOUBLE(_theta41, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta42              = KALIS_FMA_DOUBLE(_theta42, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta43              = KALIS_FMA_DOUBLE(_theta43, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta44              = KALIS_FMA_DOUBLE(_theta44, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta45              = KALIS_FMA_DOUBLE(_theta45, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta46              = KALIS_FMA_DOUBLE(_theta46, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta47              = KALIS_FMA_DOUBLE(_theta47, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta48              = KALIS_FMA_DOUBLE(_theta48, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta49              = KALIS_FMA_DOUBLE(_theta49, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta50              = KALIS_FMA_DOUBLE(_theta50, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta51              = KALIS_FMA_DOUBLE(_theta51, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta52              = KALIS_FMA_DOUBLE(_theta52, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta53              = KALIS_FMA_DOUBLE(_theta53, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta54              = KALIS_FMA_DOUBLE(_theta54, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta55              = KALIS_FMA_DOUBLE(_theta55, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta56              = KALIS_FMA_DOUBLE(_theta56, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta57              = KALIS_FMA_DOUBLE(_theta57, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta58              = KALIS_FMA_DOUBLE(_theta58, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta59              = KALIS_FMA_DOUBLE(_theta59, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta60              = KALIS_FMA_DOUBLE(_theta60, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta61              = KALIS_FMA_DOUBLE(_theta61, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta62              = KALIS_FMA_DOUBLE(_theta62, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
_theta63              = KALIS_FMA_DOUBLE(_theta63, _muTmp1a, _muTmp2a); // theta = H * (2*mu - 1) - mu + 1
#endif
...
_theta32              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(32*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(32*KALIS_DOUBLEVEC_SIZE))%32));
_theta33              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(33*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(33*KALIS_DOUBLEVEC_SIZE))%32));
_theta34              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(34*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(34*KALIS_DOUBLEVEC_SIZE))%32));
_theta35              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(35*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(35*KALIS_DOUBLEVEC_SIZE))%32));
_theta36              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(36*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(36*KALIS_DOUBLEVEC_SIZE))%32));
_theta37              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(37*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(37*KALIS_DOUBLEVEC_SIZE))%32));
_theta38              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(38*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(38*KALIS_DOUBLEVEC_SIZE))%32));
_theta39              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(39*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(39*KALIS_DOUBLEVEC_SIZE))%32));
_theta40              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(40*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(40*KALIS_DOUBLEVEC_SIZE))%32));
_theta41              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(41*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(41*KALIS_DOUBLEVEC_SIZE))%32));
_theta42              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(42*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(42*KALIS_DOUBLEVEC_SIZE))%32));
_theta43              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(43*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(43*KALIS_DOUBLEVEC_SIZE))%32));
_theta44              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(44*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(44*KALIS_DOUBLEVEC_SIZE))%32));
_theta45              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(45*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(45*KALIS_DOUBLEVEC_SIZE))%32));
_theta46              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(46*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(46*KALIS_DOUBLEVEC_SIZE))%32));
_theta47              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(47*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(47*KALIS_DOUBLEVEC_SIZE))%32));
_theta48              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(48*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(48*KALIS_DOUBLEVEC_SIZE))%32));
_theta49              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(49*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(49*KALIS_DOUBLEVEC_SIZE))%32));
_theta50              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(50*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(50*KALIS_DOUBLEVEC_SIZE))%32));
_theta51              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(51*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(51*KALIS_DOUBLEVEC_SIZE))%32));
_theta52              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(52*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(52*KALIS_DOUBLEVEC_SIZE))%32));
_theta53              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(53*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(53*KALIS_DOUBLEVEC_SIZE))%32));
_theta54              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(54*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(54*KALIS_DOUBLEVEC_SIZE))%32));
_theta55              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(55*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(55*KALIS_DOUBLEVEC_SIZE))%32));
_theta56              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(56*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(56*KALIS_DOUBLEVEC_SIZE))%32));
_theta57              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(57*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(57*KALIS_DOUBLEVEC_SIZE))%32));
_theta58              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(58*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(58*KALIS_DOUBLEVEC_SIZE))%32));
_theta59              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(59*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(59*KALIS_DOUBLEVEC_SIZE))%32));
_theta60              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(60*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(60*KALIS_DOUBLEVEC_SIZE))%32));
_theta61              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(61*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(61*KALIS_DOUBLEVEC_SIZE))%32));
_theta62              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(62*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(62*KALIS_DOUBLEVEC_SIZE))%32));
_theta63              = KALIS_SPREADBITSTO_DOUBLE((HB[(donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(63*KALIS_DOUBLEVEC_SIZE))/32]) >> ((donor*(KALIS_DOUBLEVEC_SIZE*KALIS_UNROLL)+(63*KALIS_DOUBLEVEC_SIZE))%32));
...
_theta8              = KALIS_MUL_DOUBLE(_beta8, _theta8); // (theta*beta)
_theta9              = KALIS_MUL_DOUBLE(_beta9, _theta9); // (theta*beta)
_theta10              = KALIS_MUL_DOUBLE(_beta10, _theta10); // (theta*beta)
_theta11              = KALIS_MUL_DOUBLE(_beta11, _theta11); // (theta*beta)
_theta12              = KALIS_MUL_DOUBLE(_beta12, _theta12); // (theta*beta)
_theta13              = KALIS_MUL_DOUBLE(_beta13, _theta13); // (theta*beta)
_theta14              = KALIS_MUL_DOUBLE(_beta14, _theta14); // (theta*beta)
_theta15              = KALIS_MUL_DOUBLE(_beta15, _theta15); // (theta*beta)
_theta16              = KALIS_MUL_DOUBLE(_beta16, _theta16); // (theta*beta)
_theta17              = KALIS_MUL_DOUBLE(_beta17, _theta17); // (theta*beta)
_theta18              = KALIS_MUL_DOUBLE(_beta18, _theta18); // (theta*beta)
_theta19              = KALIS_MUL_DOUBLE(_beta19, _theta19); // (theta*beta)
_theta20              = KALIS_MUL_DOUBLE(_beta20, _theta20); // (theta*beta)
_theta21              = KALIS_MUL_DOUBLE(_beta21, _theta21); // (theta*beta)
_theta22              = KALIS_MUL_DOUBLE(_beta22, _theta22); // (theta*beta)
_theta23              = KALIS_MUL_DOUBLE(_beta23, _theta23); // (theta*beta)
_theta24              = KALIS_MUL_DOUBLE(_beta24, _theta24); // (theta*beta)
_theta25              = KALIS_MUL_DOUBLE(_beta25, _theta25); // (theta*beta)
_theta26              = KALIS_MUL_DOUBLE(_beta26, _theta26); // (theta*beta)
_theta27              = KALIS_MUL_DOUBLE(_beta27, _theta27); // (theta*beta)
_theta28              = KALIS_MUL_DOUBLE(_beta28, _theta28); // (theta*beta)
_theta29              = KALIS_MUL_DOUBLE(_beta29, _theta29); // (theta*beta)
_theta30              = KALIS_MUL_DOUBLE(_beta30, _theta30); // (theta*beta)
_theta31              = KALIS_MUL_DOUBLE(_beta31, _theta31); // (theta*beta)
_theta32              = KALIS_MUL_DOUBLE(_beta32, _theta32); // (theta*beta)
_theta33              = KALIS_MUL_DOUBLE(_beta33, _theta33); // (theta*beta)
_theta34              = KALIS_MUL_DOUBLE(_beta34, _theta34); // (theta*beta)
_theta35              = KALIS_MUL_DOUBLE(_beta35, _theta35); // (theta*beta)
_theta36              = KALIS_MUL_DOUBLE(_beta36, _theta36); // (theta*beta)
_theta37              = KALIS_MUL_DOUBLE(_beta37, _theta37); // (theta*beta)
_theta38              = KALIS_MUL_DOUBLE(_beta38, _theta38); // (theta*beta)
_theta39              = KALIS_MUL_DOUBLE(_beta39, _theta39); // (theta*beta)
_theta40              = KALIS_MUL_DOUBLE(_beta40, _theta40); // (theta*beta)
_theta41              = KALIS_MUL_DOUBLE(_beta41, _theta41); // (theta*beta)
_theta42              = KALIS_MUL_DOUBLE(_beta42, _theta42); // (theta*beta)
_theta43              = KALIS_MUL_DOUBLE(_beta43, _theta43); // (theta*beta)
_theta44              = KALIS_MUL_DOUBLE(_beta44, _theta44); // (theta*beta)
_theta45              = KALIS_MUL_DOUBLE(_beta45, _theta45); // (theta*beta)
_theta46              = KALIS_MUL_DOUBLE(_beta46, _theta46); // (theta*beta)
_theta47              = KALIS_MUL_DOUBLE(_beta47, _theta47); // (theta*beta)
_theta48              = KALIS_MUL_DOUBLE(_beta48, _theta48); // (theta*beta)
_theta49              = KALIS_MUL_DOUBLE(_beta49, _theta49); // (theta*beta)
_theta50              = KALIS_MUL_DOUBLE(_beta50, _theta50); // (theta*beta)
_theta51              = KALIS_MUL_DOUBLE(_beta51, _theta51); // (theta*beta)
_theta52              = KALIS_MUL_DOUBLE(_beta52, _theta52); // (theta*beta)
_theta53              = KALIS_MUL_DOUBLE(_beta53, _theta53); // (theta*beta)
_theta54              = KALIS_MUL_DOUBLE(_beta54, _theta54); // (theta*beta)
_theta55              = KALIS_MUL_DOUBLE(_beta55, _theta55); // (theta*beta)
_theta56              = KALIS_MUL_DOUBLE(_beta56, _theta56); // (theta*beta)
_theta57              = KALIS_MUL_DOUBLE(_beta57, _theta57); // (theta*beta)
_theta58              = KALIS_MUL_DOUBLE(_beta58, _theta58); // (theta*beta)
_theta59              = KALIS_MUL_DOUBLE(_beta59, _theta59); // (theta*beta)
_theta60              = KALIS_MUL_DOUBLE(_beta60, _theta60); // (theta*beta)
_theta61              = KALIS_MUL_DOUBLE(_beta61, _theta61); // (theta*beta)
_theta62              = KALIS_MUL_DOUBLE(_beta62, _theta62); // (theta*beta)
_theta63              = KALIS_MUL_DOUBLE(_beta63, _theta63); // (theta*beta)
...
_g                   = KALIS_FMA_DOUBLE(_pi8, _theta8, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi9, _theta9, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi10, _theta10, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi11, _theta11, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi12, _theta12, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi13, _theta13, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi14, _theta14, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi15, _theta15, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi16, _theta16, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi17, _theta17, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi18, _theta18, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi19, _theta19, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi20, _theta20, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi21, _theta21, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi22, _theta22, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi23, _theta23, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi24, _theta24, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi25, _theta25, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi26, _theta26, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi27, _theta27, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi28, _theta28, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi29, _theta29, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi30, _theta30, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi31, _theta31, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi32, _theta32, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi33, _theta33, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi34, _theta34, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi35, _theta35, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi36, _theta36, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi37, _theta37, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi38, _theta38, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi39, _theta39, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi40, _theta40, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi41, _theta41, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi42, _theta42, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi43, _theta43, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi44, _theta44, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi45, _theta45, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi46, _theta46, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi47, _theta47, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi48, _theta48, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi49, _theta49, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi50, _theta50, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi51, _theta51, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi52, _theta52, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi53, _theta53, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi54, _theta54, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi55, _theta55, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi56, _theta56, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi57, _theta57, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi58, _theta58, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi59, _theta59, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi60, _theta60, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi61, _theta61, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi62, _theta62, _g); // g += Pi * (theta*beta)
_g                   = KALIS_FMA_DOUBLE(_pi63, _theta63, _g); // g += Pi * (theta*beta)
